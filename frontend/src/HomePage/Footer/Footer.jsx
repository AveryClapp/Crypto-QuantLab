      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-3 gap-20">
          ...
          <div className="col-start-3 justify-self-center">
            ...
            <p className="text-gray-400 mb-2">Email: avery.clapp@gmail.com</p>
            <p className="text-gray-400">Phone: +1 (513) 212-8500</p>
            {/* Social Media Icons */}
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center">
          <p className="text-gray-400">
            © 2024 Crypto Trading Platform. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
